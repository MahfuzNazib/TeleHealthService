                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="#ServicingTime">Servicing Time</a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <p class="footer-text m-0 col-lg-8 col-md-12"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Application is Developed <i class="ti-heart" aria-hidden="true"></i> by <a href="https://mahfuznazib.github.io/index.html" target="newWindow">Nazib Mahfuz</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="/myStyle/js/jquery-1.12.1.min.js"></script>
    <!-- popper js -->
    <script src="/myStyle/js/popper.min.js"></script>
    <!-- bootstrap js -->
    <script src="/myStyle/js/bootstrap.min.js"></script>
    <!-- owl carousel js -->
    <script src="/myStyle/js/owl.carousel.min.js"></script>
    <script src="/myStyle/js/jquery.nice-select.min.js"></script>
    <!-- contact js -->
    <script src="/myStyle/js/jquery.ajaxchimp.min.js"></script>
    <script src="/myStyle/js/jquery.form.js"></script>
    <script src="/myStyle/js/jquery.validate.min.js"></script>
    <script src="/myStyle/js/mail-script.js"></script>
    <script src="/myStyle/js/contact.js"></script>
    <!-- custom js -->
